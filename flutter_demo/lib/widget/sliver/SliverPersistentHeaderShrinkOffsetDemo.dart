...
class SliverPersistentHeaderShrinkOffsetDemo extends StatefulWidget {
  final String title;

  SliverPersistentHeaderShrinkOffsetDemo({Key key, this.title})
      : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _SliverPersistentHeaderShrinkOffsetDemoState();
  }
}

class _SliverPersistentHeaderShrinkOffsetDemoState extends State {
  @override
