...
import 'package:flutterdemo/widget/sliver/CustomScrollViewDemo.dart';
...
import 'package:flutterdemo/widget/sliver/SliverPersistentHeaderStickyDemo.dart';
import 'package:flutterdemo/widget/willpopscope/WillPopScopeWidget.dart';
import 'package:http/http.dart' as http;

class DemoList extends StatelessWidget with WidgetsBindingObserver {
...
//    return new Text(wordPair.asPascalCase);
  ...
  void didChangeAppLifecycleState(AppLifecycleState state) {
    print(
        'RandomWords ----------didChangeAppLifecycleState-----------state : ${state}');
  }
