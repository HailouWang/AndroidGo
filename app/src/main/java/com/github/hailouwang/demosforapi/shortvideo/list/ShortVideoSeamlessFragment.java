...
public class ShortVideoSeamlessFragment extends RecyclerViewAutoPlayFragment {

    private boolean mSkipToDetail;

    @Override
    protected int getLayoutResId() {
        return com.dueeeke.dkplayer.R.layout.dueeeke_fragment_recycler_view;
    }
    ...
    protected void initView() {
        ...
        mAdapter.setOnItemClickListener(position -> {
            ...
            View sharedView = mLinearLayoutManager.findViewByPosition(position).findViewById(com.dueeeke.dkplayer.R.id.player_container);
            //使用共享元素动画
