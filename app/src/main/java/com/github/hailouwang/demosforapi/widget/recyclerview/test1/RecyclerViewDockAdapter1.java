...
public class RecyclerViewDockAdapter1 extends RecyclerView.Adapter<BaseRecyclerViewAdapterVh1> {
    ...
    public RecyclerViewDockAdapter1(List<String> datas) {
    ...
    public void addFooterView(Context context){
        footer = new DockRecyclerViewItem(context);
