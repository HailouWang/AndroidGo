...
import com.github.hailouwang.demosforapi.widget.recyclerview.test2.RecyclerViewDockAdapter2;
...
public class RecyclerViewActivity3 extends AppCompatActivity {
    ...
    private RecyclerViewTest3FrameLayout container;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.recycler_view_test3);
        ...
        container.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                onSubViewHeightChange();
            }
        });
        container.addView(dockRecyclerViewItem2.itemView);
        container.setFooterView(footer.itemView);
        container.setOuterRecyclerView(recyclerView);
        container.setInnerRecyclerView(dockRecyclerViewItem2.getRecyclerView());
    }

    private void onSubViewHeightChange() {
        //设置footerview高度
