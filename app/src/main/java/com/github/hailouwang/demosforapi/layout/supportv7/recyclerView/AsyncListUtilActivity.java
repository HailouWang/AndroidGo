...
package com.github.hailouwang.demosforapi.layout.supportv7.recyclerView;
...
import com.github.hailouwang.demosforapi.layout.supportv7.Cheeses;
...
public class AsyncListUtilActivity extends Activity {
    ...
    private class AsyncAdapter extends RecyclerView.Adapter<TextViewHolder> {
        ...
        public void onBindViewHolder(TextViewHolder holder, int position) {
            ...
            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy onBindViewHolder position:"+position);
            if (itemString == null) {
        ...
        public AsyncStringListUtil() {
            super(String.class, TILE_SIZE,
                    new DataCallback<String>() {
                        ...
                        public int refreshData() {//后台刷新数据，得到数据的数量
                            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy refreshData");
                        ...
                        public void fillData(String[] data, int startPosition, int itemCount) {
                            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy fillData startPosition:"+startPosition
                            +",itemCount:"+itemCount);
                            sleep();
                    ...
                    new ViewCallback() {
                        ...
                        public void getItemRangeInto(int[] outRange) {
                            ...
                            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy AsynclistUtils getItemRangeInto:"+outRange[0]
                                    +",outRange:"+outRange[1]);
                        }

                        @Override
                        public void onDataRefresh() {
                            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy onDataRefresh");
                            mRecyclerView.getAdapter().notifyDataSetChanged();
                        }

                        @Override
                        public void onItemLoaded(int position) {
                            Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy onItemLoaded position:"+position);
            ...
            mRecyclerView.addOnScrollListener(new RecyclerView.OnScrollListener() {
                ...
                public void onScrolled(RecyclerView recyclerView, int dx, int dy) {
                    Log.d(Tags.HLWANG_TAG,"AsyncListUtilsActiviy AsynclistUtils dx:"+dx
                    +",dy:"+dy);
                    onRangeChanged();
                }
            });
