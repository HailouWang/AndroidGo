...
import com.github.hailouwang.demosforapi.widget.recyclerview.test5.vh.BaseRecyclerViewAdapterVh1;
import com.github.hailouwang.demosforapi.widget.recyclerview.test5.vh.DockRecyclerViewItem;
import com.github.hailouwang.demosforapi.widget.recyclerview.test5.vh.TextRecyclerViewItem;
...
public class RecyclerViewDockAdapter5 extends RecyclerView.Adapter<BaseRecyclerViewAdapterVh1> {
    ...
    private static final int VIEW_TYPE_STRING_SINBLE = 1;
    private static final int VIEW_TYPE_STRING_DOUBLE = 2;
    private static final int VIEW_TYPE_DOCKER = 3;
